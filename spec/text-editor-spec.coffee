...
describe "TextEditor", ->
  ...
  describe ".copy()", ->
    it "returns a different editor with the same initial state", ->
      ...
      editor.setFirstVisibleScreenColumn(4)
      expect(editor.getFirstVisibleScreenColumn()).toBe(4)
      editor.foldBufferRow(4)
      expect(editor.isFoldedAtBufferRow(4)).toBeTruthy()
      ...
      expect(editor2.getSelections()[1].isReversed()).toBeTruthy()
      expect(editor2.getFirstVisibleScreenRow()).toBe(3)
      expect(editor2.getFirstVisibleScreenColumn()).toBe(4)
      expect(editor2.isFoldedAtBufferRow(4)).toBeTruthy()
